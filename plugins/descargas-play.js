...
author = author || 'no encontrado'
    ...
    if (command === '' || command === 'yta' || command === '' || command === 'playaudio') {
      try {
    ...
    } else if (command === 'play2' || command === 'ytv' || command === '' || command === 'mp4') {
      try {
...
handler.command = handler.help = ['playaudio', 'yta','ytv','playvideo', 'mp4']
