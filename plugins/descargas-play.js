...
author = author || 'no encontrado'
    ...
    if (command === 'playaudio' || command === 'yta' || command === '' || command === 'playaudio') {
      try {
    ...
    } else if (command === '' || command === 'ytv' || command === '' || command === 'mp4') {
      try {
...
handler.command = handler.help = ['yta',  'ytv', 'ytmp4', 'playaudio', 'mp4']
